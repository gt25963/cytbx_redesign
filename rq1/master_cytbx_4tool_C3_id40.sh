...
# CytbX 4-Tool Combined Pipeline - RQ1 - C3 Cycle 4 (id40)
# Mirrors master_cytbx_4tool_C3_id11.sh exactly except that the starting structure comes from the id40 lineage.
# These different starting structures were used to explore a bigger range of the design space, then the top-scoring sequences across all lineages were compared during expert-in-the-loop inspection.
...
master_folder="CytbX_4tool_C3_id40"
...
initial_structure="main_pipeline/CytbX_4tool_C3/cycle_4_seed_id40.pdb"
...
echo "Multi-tool pipeline (C3) starting at $(timestamp)"
