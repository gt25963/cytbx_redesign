...
# CytbX 4-Tool Combined Pipeline - RQ1 - C3 Cycle 4 (id11 lineage)
...
master_folder="CytbX_4tool_C3_id11"
...
initial_structure="main_pipeline/CytbX_4tool_C3/cycle_4_seed_id11.pdb"
...
# Compiles top scores per track method, and those are then individually inspected through expert-in-the-loop.
