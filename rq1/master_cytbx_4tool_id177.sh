...
# CytbX 4-Tool Combined Pipeline - RQ1 - C2 Cycle 4
# protein_chain_count=2 throughout (C2 dimer). 
# Starting structure from the id177 lineage
...
master_folder="CytbX_4tool_id177"
...
# STARTING STRUCTURE
initial_structure="main_pipeline/CytbX_4tool/cycle_4_seed_id177.pdb"
