...
# --- STARTING STRUCTURE ---
initial_structure="/scratch/b5ae/mvg2713124.b5ae/cytbx_pipeline/main_pipeline/CytbX_C3/cycle_1/chai/outputs/top_scoring.cif_id20/pred.model_idx_0.cif"
...
for i in $(seq 3 $number_of_iterations); do
