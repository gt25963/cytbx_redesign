...
# --- STARTING STRUCTURE ---
initial_structure="/scratch/b5ae/mvg2713124.b5ae/cytbx_pipeline/main_pipeline/CytbX_C2/cycle_1/chai/outputs/top_scoring.cif_id15/pred.model_idx_1.cif"
...
for i in $(seq 4 $number_of_iterations); do
