#!/usr/bin/env python
"""
RQ1 C3 Trimer: Iterative Design Trajectory, white background, 5 cycles.
...
fig.tight_layout()
fig.savefig("rq1_c3_trajectory_white_v2.png", dpi=300, bbox_inches="tight", facecolor="white")
print("Saved: rq1_c3_trajectory_white_v2.png")
