...
# Measure FMN displacement between the cycle-1 packed LigandMPNN scaffold and the AF3 top model for id11, after aligning on protein CA atoms.
# Tells whether AF3 moved the cofactor from the deliberately-constructed pose. 
...
sup.apply(list(s_af3.get_atoms())) ## apply the protein-derived transform to the whole AF3 structure
