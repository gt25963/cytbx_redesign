...
out_csv = f"{trajectory_dir}/all_scores_FMN_hemB.csv"
...
seeds_csv = f"{trajectory_dir}/next_cycle_seeds.csv"
seeds_txt = f"{trajectory_dir}/next_cycle_seeds.txt"
seed_rows = []
lines = [f"RQ2 FMN-at-HEM_B cycle 1 -- per-track seed selection", f"From {len(results)} scored sequences", ""]
