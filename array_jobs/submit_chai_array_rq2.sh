...
#FMN version for chai script - block size fixed as always exactly 3 records (protein + Hem2 + FMN)
ids_list=$1
chai_input_fa=$2
output_base_dir=$3
...
# RQ2 record = protein + HEM + cofactor = 3 records = 6 lines
...
conda activate chai
#Run chai on this single candidate's extracted fasta
